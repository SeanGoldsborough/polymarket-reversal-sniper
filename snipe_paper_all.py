...
PAPER_MODE = True  # Always paper
ASSETS = ["BTC", "SOL", "ETH", "XRP", "DOGE"]
...
BOT_NAME = "SNIPE-ALL-PAPER"
LOG_FILE = "logs/snipe_paper_all_trades.jsonl"
SUMMARY_FILE = "logs/snipe_paper_all_summary.json"
