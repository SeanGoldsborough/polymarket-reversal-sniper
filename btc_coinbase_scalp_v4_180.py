...
FORCE_EXIT_BEFORE_END = 120 # Force exit at T+180 (120s before window end) — exit while token still mid-range
...
PAPER_MODE = os.getenv("BTC_SCALP_V4_180_LIVE", "0") != "1"
POLY_WS_URL = "wss://ws-subscriptions-clob.polymarket.com/ws/market"
CB_WS_URL = "wss://ws-feed.exchange.coinbase.com"

os.makedirs("logs", exist_ok=True)
BOT_NAME = "BTC-SCALP-V4-180" if not PAPER_MODE else "BTC-SCALP-V4-180-PAPER"
LOG_FILE = "logs/btc_scalp_v4_180_trades.jsonl"
SUMMARY_FILE = "logs/btc_scalp_v4_180_summary.json"
